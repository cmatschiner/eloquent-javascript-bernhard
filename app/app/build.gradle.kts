...
android {
    namespace = "at.matschiner.meetminutes"
    // compileSdk 35 (Android 15) with AGP 8.7.x. Bump to 36 (Android 16) together
    // with AGP >= 8.9 in a later, low-risk step – see docs/06_Sprint0_Status.md.
    compileSdk = 35
